(() => {
  ...
  var require_lodash_min = __commonJS({
    "libs/lodash.min.js"(exports, module) {
      (function() {
        function n(n2, t2, r2) {
          switch (r2.length) {
            case 0:
        ...
        var Gr = {
          ...
          (ns && zs(new ns(new ArrayBuffer(1))) != ct || ts && zs(new ts()) != Gn || rs && zs(rs.resolve()) != Qn || es && zs(new es()) != tt || us && zs(new us()) != it2) && (zs = function(n2) {
  ...
  // core/utils/dataUtils.js
  var import_lodash_min = __toESM(require_lodash_min());
  function deepClone(obj) {
    return import_lodash_min.default.cloneDeep(obj);
  }
  function deepMerge(target, source) {
    return import_lodash_min.default.merge({}, target, source);
  }

  // tests/core/utils/dataUtils.test.js
  describe("dataUtils", function() {
    it("deepClone deber\xEDa clonar profundamente un objeto", function() {
      const obj = { a: 1, b: { c: 2 } };
    ...
    it("deepMerge deber\xEDa fusionar profundamente dos objetos", function() {
